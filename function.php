<?php
$conn = mysqli_connect('localhost', 'root', '', 'smart-web');
...
function edit()
{
	...
	$email       =  escape($_POST['email']);
	$id          =  $_SESSION['id'];
	mysqli_query($conn, "UPDATE `users` SET `FullName` = '$fullname', `Email`='$email' WHERE `UserId` = '$id'");

	$_SESSION['prompt']  = "Change successfully";
