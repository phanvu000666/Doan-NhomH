...
?>
<center><h2 style=" background-color: #5a88ca;color:#fff;padding: 10px; font-size: 40px;"><?php  foreach ($manuName as $mnname) { echo $mnname['ManufacturerName'];} ?></h2></center>
<div class="main-ver2">
