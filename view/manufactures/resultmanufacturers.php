...
<center>
    ...
    <?php foreach ($manuName as $mnname) { echo $mnname['ManufacturerName']; } ?></h2>
</center>
            ...
            <div class="col-md-12">
                ...
                if (count($result2) < 1) {
                    ...
                    <div class='single-shop-product'>
                        ...
                        <h2><a href='single-product.php?id=" . $result2[$key]['ProductID'] . "'>" . ($result2[$key]['ProductName']) 
                        . "</a></h2>
                        ...
                        <div class='product-option-shop'>
                            <a class='add_to_cart_button' data-quantity='1' data-product_sku='' data-product_id='70'
                             rel='nofollow' href='updateOrder.php?id=" . $result2[$key]['ProductID'] . "&action=3'>Add to cart</a>
                        </div>   
                        </div>              
                    </div>";
                ?>
